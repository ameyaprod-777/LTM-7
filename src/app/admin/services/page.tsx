...
export const metadata = { title: "Modération services" };
...
export default async function AdminServicesPage({
  ...
  const services = await prisma.service.findMany({
    ...
    include: {
      ...
      _count: { select: { quotes: true, reports: true } },
    },
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold text-anthracite">Modération des services</h1>
      <p className="mt-1 text-sm text-anthracite-500">
        Activer, mettre en pause ou masquer les prestations signalées.
      </p>
      ...
      <form className="mt-6 flex flex-wrap gap-3">
        ...
        >
          ...
          <option value="REMOVED">Masqué</option>
        </select>
        <button
          type="submit"
